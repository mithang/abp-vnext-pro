...
import { Language, Tenant, User, Token, LogoutPayload } from '../../types';

interface SettingsScreenProps {
  navigation: any;
  language: Language;
  languages: Language[];
  setLanguageAsync: (cultureName: string) => void;
  logoutAsync: (payload: LogoutPayload) => void;
  tenant: Tenant;
}
...
function SettingsScreen({
  ...
  const fetchUser = () => {
    getProfileDetail().then((data: User) => {
